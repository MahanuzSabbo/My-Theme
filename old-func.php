...
//  JS files connection  with version numbers
function my_theme_enqueue_scripts() {
    ...
    wp_register_script(
        'jquery-script',
        $template_directory . '/assets/js/jquery-3.2.1.min.js',
        array('jquery'), 
        '3.2.1', 
        true 
    );
    ...
    wp_register_script(
        'main-script',
        $template_directory . '/assets/js/main.js',
        array('jquery'), 
        null, 
        true 
    );
    ...
    wp_register_script(
        'modernizr-script',
        $template_directory . '/assets/js/modernizr.js',
        array(), 
        null, 
        false 
    );
    ...
    wp_register_script(
        'pace-script',
        $template_directory . '/assets/js/pace.js',
        array(), 
        null, 
        true 
    );
    ...
    wp_register_script(
        'plugins-script',
        $template_directory . '/assets/js/plugins.js',
        array(),
        null, 
        true 
    );
...
//font connection 
//Font Awesome
function add_fonts_awesome() {
    wp_enqueue_style(
        'font-awesome', 
        'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css', // Font Awesome CDN URL
        array(),
        null 
    );
}
add_action('wp_enqueue_scripts', 'add_fonts_awesome');
